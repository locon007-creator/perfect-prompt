...
const cases = [
  {
    ...
    owned: 'Choose Fixed or Variable in Income Setup',
  },
  {
    name: 'task flow',
    ...
    owned: 'Use minimal typing in Add Task',
  },
  {
    name: 'recipe flow',
    ...
    owned: 'Show quick filters in Choose Recipe',
  },
  {
    name: 'driver flow',
    ...
    owned: 'Add and reorder stops in Create Route',
  },
];
