...
const cases = [
  {
    ...
    owned: 'Income Setup: Choose Fixed or Variable',
  },
  {
    name: 'task flow',
    ...
    owned: 'Add Task: Use minimal typing',
  },
  {
    name: 'recipe flow',
    ...
    owned: 'Choose Recipe: Show quick filters',
  },
  {
    name: 'driver flow',
    ...
    owned: 'Create Route: Add and reorder stops',
  },
];
