...
type IconName='menu'|'paste'|'trash'|'sparkle'|'copy'|'save'|'bulb'|'phone'|'tool'|'chart'|'finance'|'truck'|'chevron';
...
function Icon({name}: {name:IconName}){
 ...
 const paths:Record<IconName,React.ReactNode>={
  menu:<><path d="M4 6h16M4 12h16M4 18h16"/></>,paste:<><path d="M9 5h6M9 3h6v4H9z"/><path d="M7 6H5v15h14V6h-2"/></>,trash:<><path d="M4 7h16M9 7V4h6v3M7 7l1 13h8l1-13M10 11v5M14 11v5"/></>,sparkle:<><path d="M12 2l1.5 4.5L18 8l-4.5 1.5L12 14l-1.5-4.5L6 8l4.5-1.5L12 2z"/><path d="M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8L19 14z"/></>,copy:<><rect x="8" y="8" width="11" height="12" rx="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h2"/></>,save:<><path d="M6 3h12v18l-6-4-6 4V3z"/></>,bulb:<><path d="M9 18h6M10 22h4"/><path d="M8.5 14.5A6 6 0 1 1 15.5 14.5c-.9.8-1.5 1.7-1.5 3h-4c0-1.3-.6-2.2-1.5-3z"/></>,phone:<><rect x="6" y="3" width="12" height="18" rx="2"/><path d="M10 18h4"/></>,tool:<><path d="M14.7 6.3a4 4 0 0 0-5 5L4 17l3 3 5.7-5.7a4 4 0 0 0 5-5l-2.2 2.2-3-3 2.2-2.2z"/></>,chart:<><path d="M5 20V10M12 20V4M19 20v-7"/></>,finance:<><path d="M4 7c0-2 3.6-3 8-3s8 1 8 3-3.6 3-8 3-8-1-8-3z"/><path d="M4 7v5c0 2 3.6 3 8 3s8-1 8-3V7M4 12v5c0 2 3.6 3 8 3s8-1 8-3v-5"/></>,truck:<><path d="M3 7h11v9H3zM14 10h4l3 3v3h-7z"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/></>,chevron:<><path d="M9 5l7 7-7 7"/></>
 };
...
function App(){
 ...
 return <main className="app-shell">
  ...
  <section className="idea-panel" aria-label="Describe your app idea">
   <div className="idea-heading"><div className="idea-title"><span className="pencil">✎</span><strong>Describe your app idea</strong></div><div className="idea-tools"><button onClick={paste}><Icon name="paste"/>Paste</button><button onClick={clearIdea}><Icon name="trash"/>Clear</button></div></div>
   ...
   {!idea&&<p className="example">Example: A budgeting app for personal use with a clean mobile design, offline support, and spending insights...</p>}
